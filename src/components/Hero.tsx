      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
            We believe every child deserves the opportunity to discover their strength, build confidence, and be part of a supportive community. Join us in teaching adaptive fencing to neurodivergent youth.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button 
              ...
              size="lg"
              variant="outline"
              className="text-lg border-2 border-white hover:bg-white hover:text-primary"
            >
              Learn More
            </Button>
          </div>
